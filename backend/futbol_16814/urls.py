"""futbol_16814 URL Configuration
...
admin.site.site_header = "Futbol"
admin.site.site_title = "Futbol Admin Portal"
admin.site.index_title = "Futbol Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Futbol API",
        default_version="v1",
        description="API documentation for Futbol App",
    ),
    public=True,
